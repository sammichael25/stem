            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" data-background-color="purple">
                        <h4 class="title">Staff Listing</h4>
                    @if( isset($employee->type))
                        <p class="category">Here is a list of all {{ $employee->type }}</p>
                    @else
                        <p class="category">Here is a list of all Employees</p>
                    @endif
                    </div>
                    <div class="card-content table-responsive">
                        <table class="table" id="employeeDatatable" data-toggle="table" data-show-columns="true" data-search="true" data-show-toggle="true" data-show-export="true" data-pagination="true" data-buttons-class="info" data-export-options='{"fileName": "test"}' data-export-types="['csv', 'txt', 'sql', 'excel']">
